...
total_ssim = 0.
count = 0
img_path = r'/opt/data/private/kls/Test_code/EVSSM_model/results_final/Realblur_R/GoPro/'
gt_path = r'/opt/data/private/kls/dataset/test/Realblur_R/test/target/'
print(img_path)
for img_name in os.listdir(img_path ):
  count += 1

  img_dir = img_path + '/' + img_name
  gt_dir = gt_path + '/' + img_name
